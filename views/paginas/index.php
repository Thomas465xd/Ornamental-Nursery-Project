...
<section class="icons-container">
    ...
    <div class="icons">
        <img src="../../build/img/icon-1.svg" alt="entrega">
        <div class="info">
            <h3>Envío a Todo Chile</h3>
            <span>Envio a un Costo increible</span>
        </div>
    </div>
    ...
    <div class="icons">
        <img src="../../build/img/icon-3.svg" alt="entrega">
        <div class="info">
            <h3>Variedad Increible</h3>
            <span>Todas las plantas que puedas imaginar</span>
        </div>
    </div>

    <div class="icons">
        <img src="../../build/img/icon-4.svg" alt="entrega">
        <div class="info">
...
<section class="products" id="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="../../build/img/img1.jpg" alt="producto1">
                <div class="icons">
                    <a href="#">
            ...
            <div class="content">
                <h3>Suculenta</h3>
                <div class="price">Precio: $12.990 <span> $15.990 </span></div>
        ...
        <div class="box">
            <span class="discount">-10%</span>
            <div class="image">
                <img src="../../build/img/img2.jpg" alt="producto1">
                <div class="icons">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
        ...
        <div class="box">
            <span class="discount">-10%</span>
            <div class="image">
                <img src="../../build/img/img3.jpg" alt="producto1">
                <div class="icons">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
...
<section class="review" id="review">
    ...
    <h1 class="heading">Opiniones <span>Clientes</span></h1>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias delectus perspiciatis eaque maiores modi, harum quidem? Dolores enim, distinctio provident consectetur blanditiis, perferendis nemo odit, labore fugiat dolor voluptas mollitia.</p>
            <div class="user">
                <img src="../../build/img/user1.jpg" alt="user">
                <div class="user-info">
                    <h3>Iñigo Del Campo</h3>
                    <span>Comprador Satisficho</span>
                </div>
            </div>
            <span class="quote">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="box">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias delectus perspiciatis eaque maiores modi, harum quidem? Dolores enim, distinctio provident consectetur blanditiis, perferendis nemo odit, labore fugiat dolor voluptas mollitia.</p>
            <div class="user">
                <img src="../../build/img/user2.jpg" alt="user">
                <div class="user-info">
                    <h3>Francisca Jara</h3>
                    <span>Comprador Satisficho</span>
                </div>
            </div>
            <span class="quote">
        ...
        <div class="box">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias delectus perspiciatis eaque maiores modi, harum quidem? Dolores enim, distinctio provident consectetur blanditiis, perferendis nemo odit, labore fugiat dolor voluptas mollitia.</p>
            <div class="user">
                <img src="../../build/img/user3.jpg" alt="user">
                <div class="user-info">
                    <h3>Jimmy McGill</h3>
                    <span>Comprador Satisficho</span>
                </div>
